...
import { ArrowLeft, ArrowRight, Sparkles, Loader2, ChevronDown } from "lucide-react";
...
export const IdeaForm = ({ value, onChange, onSubmit, onBack }: Props) => {
  ...
  // No required fields — panel can run on whatever the founder provides.
    ...
    <div className="min-h-screen relative bg-background">
      ...
      <main className="relative z-10 container max-w-2xl pb-40 pt-8">
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease }}>
          ...
          <p className="text-muted-foreground mb-14 text-lg font-light leading-relaxed max-w-xl">
